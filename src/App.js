...
const products = [
  {
    name: "S1",
    url:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR36tB8-JRtR18TrRQL6XbHbyiq3F765is2_s2bfXDZR2zkS0mHpOBEEEQljL9UD1EHLx4W1h8&usqp=CAc",
    id: "s1",
    price: "20$",
    key: 1,
  },
  {
    name: "S2",
    url:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSkoQAXeU62GB8mIxe2-cJ6GdyCH3mgf_E7buDbb2Uixqgpu_lNbk3L8cJ4&usqp=CAc",
    id: "s2",
    price: "10$",
    key: 2,
  },
  {
    name: "S3",
    url:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRjWZnXVui-R5ABkL-y1pDniqbynweqtacjiCTzDxficch3jfgpcK_5tuFz3T-Ujl7kQ6yK-OI&usqp=CAc",
    id: "s3",
    price: "86$",
    key: 3,
  },
  ...
  },
  {
    name: "S6",
    url:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTHEfg8n0KLsL4wfue1mPYMurDIGBzXGfyzrw&usqp=CAU",
    id: "s6",
    price: "544$",
    key: 6,
  },
  ...
  return (
    <div className="App">
      ...
      <Link
        to={{
          pathname: "/ShowCart",
          state: Cart, // your data array of objects
        }}
      >
        {" "}
            ...
            <div key={product.id}>
              ...
              <button
                onClick={() => {
                  ...
                  // setCart([product], console.log(Cart));
                }}
              >
                Add To Cart
              </button>
